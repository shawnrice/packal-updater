  ...
  <body>
    ...
    <script type='text/javascript' >
      ...
      $( '.nav' ).click( function() {
        ...
        // This just makes the menu go away when you select an option, basically duplicated from the borderMenu.js script. Also, add a timeout so it's not too sudden.
